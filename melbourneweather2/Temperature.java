...
public class Temperature {
	...
	private static String temp,temperature,temperatureLoc,temperatureTime;
	...
	public Temperature(String Location){
		...
		try {
			getTemperatureFromServerStage1();
	...
	public static String[] getTemperatureFromServerStage1() throws RemoteException, ExceptionException{
